                        ...
                        <li class="dropdown">
                            <a href="#" data-bs-toggle="dropdown"
                                ...
                                @if (Auth::user())    
                                    ...
                                    <div class="d-none d-md-block d-lg-inline-block">Hi, {{ Auth::user()->username }} - Admin</div>
                                    @else
                                    <div class="d-none d-md-block d-lg-inline-block">Hi, {{ Auth::user()->username }} - Client</div>
                                    @endif
                                @endif
                            </a>
                            <div class="dropdown-menu dropdown-menu-end">
