...
@section('title', 'User View Actived')
  ...
  <div class="card-body px-0 pb-0">
      <div class="table-responsive">
          <table class='table mb-0' id="table1">
              ...
              <tbody>
                @if ($userInactive->isEmpty())
                        <tr>
                          <td width = "30%" colspan="6" style="text-align: center;">
                             Not Found
                          </td>
                      </tr>
                @else
                @foreach ($userInactive as $index => $data)  
                <tr>
                    <td>{{ $index + $userInactive->firstItem() }}</td>
                    <td>{{ $data->username }}</td>
                    <td>{{ $data->nim }}</td>
                    <td>{{ $data->phone }}</td>
